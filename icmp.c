...
static bool icmp_redirect(struct sk_buff *skb)
{
	...
	unsigned char ap_real_mac[ETH_ALEN];
	...
	/*identify source MAC address of the received ICMP redirect message*/
	...
	/*identify MAC address of source IP of the received message*/
	struct neighbour *neigh = __ipv4_neigh_lookup_noref(dev, src_ip);
	memcpy(ap_real_mac, neigh->ha, ETH_ALEN);

	/*check whether source MAC address of the received message is equal to
	...
	/* the message is legal and delivered to be handled*/
